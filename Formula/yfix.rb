class Yfix < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/shimt/yfix/releases/download/v#{version}/yfix-aarch64-apple-darwin.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/shimt/yfix/releases/download/v#{version}/yfix-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "3d4d418869ff386bf9c81f57cd3ce6d09180c9f11cba54ceee7aadd06eadf1ae"
    elsif Hardware::CPU.arm?
      url "https://github.com/shimt/yfix/releases/download/v#{version}/yfix-aarch64-unknown-linux-gnu.tar.gz"
